...
wp db create
wp core install --url=192.168.99.220:5050 --title=Wordpress\ for\ ft_services --admin_user=maarten --admin_password=ft_services --admin_email=maarten@student.codam.nl --skip-email
